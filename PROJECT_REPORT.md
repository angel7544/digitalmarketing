...
<p style="margin: 8px 0;"><a href="#dfd" style="text-decoration: none; color: #333;">5. Data Flow Diagrams</a></p>
<p style="margin: 8px 0;"><a href="#implementation" style="text-decoration: none; color: #333;">6. Implementation Case Studies</a></p>
<p style="margin: 8px 0;"><a href="#ui-mockups" style="text-decoration: none; color: #333;">7. User Interface Mockups</a></p>
<p style="margin: 8px 0;"><a href="#security" style="text-decoration: none; color: #333;">8. Security Considerations</a></p>
<p style="margin: 8px 0;"><a href="#limitations" style="text-decoration: none; color: #333;">9. Limitations</a></p>
<p style="margin: 8px 0;"><a href="#conclusion" style="text-decoration: none; color: #333;">10. Conclusion</a></p>
</div>
</div>
...
<h2 id="dfd" style="font-size: 22px; color: #2563eb; margin-top: 40px; margin-bottom: 20px;">5. Data Flow Diagrams</h2>
...
<h2 id="implementation" style="font-size: 22px; color: #2563eb; margin-top: 40px; margin-bottom: 20px;">6. Implementation Case Studies</h2>
...
<h2 id="ui-mockups" style="font-size: 22px; color: #2563eb; margin-top: 40px; margin-bottom: 20px;">7. User Interface Mockups</h2>
...
<h2 id="security" style="font-size: 22px; color: #2563eb; margin-top: 40px; margin-bottom: 20px;">8. Security Considerations</h2>
